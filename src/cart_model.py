...
# Çıktı klasörlerinin varlığından emin olalım
...
# Makaledeki Spesifikasyon Limitlerine Göre Sınıflar [cite: 41, 43]
class_names = [
    "Class 0 (Ra < 0.11 um)",   # Alt limit altı fire [cite: 41, 43]
    "Class 1 (0.11 <= Ra <= 0.45 um)", # Kabul edilebilir kaliteli ürün [cite: 41, 43]
    "Class 2 (Ra > 0.45 um)"    # Üst limit üstü fire [cite: 41, 43]
]
...
matrix_path = "outputs/figures/cart_gini_confusion_matrix.png"
...
plt.tight_layout()
tree_path = "outputs/figures/gini_optimized_tree.png"
