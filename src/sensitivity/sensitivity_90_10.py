# =============================================================================
# sensitivity_90_10.py (REVISED Y-LIMIT TO 75% FOR HIGH ACCURACIES)
# Knife Surface Analysis — Actual 90/10 Split with Depth Tuning Curves
...
print("=" * 75)
print("RUNNING GENUINE DEPTH SENSITIVITY FOR 90/10 SPLIT (REVISED Y-LIMIT)...")
print("=" * 75)
...
for idx, p in enumerate(train_percentages):
    test_size = 1.0 - p
    gss = GroupShuffleSplit(n_splits=1, test_size=test_size, random_state=200 + idx)
    ...
    # --- SCENARIO B: ALL IMAGING FILTERS INCLUDED ---
...
# =============================================================================
# 3. REPLICATING PAPER FIGURE 4 GRAPHICAL LAYOUT (90/10 COHORT MODE)
# =============================================================================
...
ax.set_title("Correctly Classified Data in Dependence of the Quantity of Training Data (90/10 Split)", fontsize=12, pad=15, fontweight='bold')
...
# GÜNCELLEME: Çıktı Fig12 ismiyle 4_sensitivity_analysis klasörüne kaydediliyor
fig_path = os.path.join(output_dir, "Fig12_paper_style_curve_90_10.png")
plt.savefig(fig_path, bbox_inches='tight', dpi=300)
plt.close()

print(f"✓ 90/10 trend graphics with expanded Y-limit successfully saved to: '{fig_path}'")