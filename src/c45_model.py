...
# Makale Limitleri: Class 0 (Ra < 0.11), Class 1 (0.11 <= Ra <= 0.45), Class 2 (Ra > 0.45) [cite: 43, 324]
class_names = [
    "Class 0 (Ra < 0.11 um)", 
...
matrix_path = "outputs/figures/c45_unpruned_confusion_matrix.png"
...
plt.tight_layout()
tree_path = "outputs/figures/c45_unpruned_tree.png"
